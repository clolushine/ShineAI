...
***<p align="center">📢 [公告] JetBrains IDEA 插件版本即将停止维护。如需可迁移至功能更强大、跨平台支持的全新版本：[点击访问](https://x.5205203.xyz/)</p>***
...
> [!IMPORTANT]
> ShineAI 的核心功能依赖于个人维护的**非开源后端 API 服务**。

*   **后端状态：** 本项目的后端代码**未开源**。
*   **数据处理：** 后端会处理并存储您的聊天内容、图片和附件，以支持聊天历史记录和多设备访问。
*   **隐私与规模声明：**
    *   **个人项目性质**：此服务由个人开发维护，主要面向**个人、非商业、实验或体验性质的使用**。
    *   **不支持商业规模**：**由于服务器资源有限，无法支撑商业规模、高并发量或企业级工作负载**。大规模使用可能导致服务中断或访问受限。
    *   **隐私与数据安全**：作为个人项目，已尽力保护数据，但**无法提供企业级 SLA 或 100% 数据安全保障**。**建议避免上传高度敏感、机密商业数据或专有信息。**
    *   **商业需求建议**：如果需要高可用、可扩展或定制集成，**建议可fork该项目自行实现后端解决方案**。
...
*   **全平台版本：** [点击访问](https://x.5205203.xyz/)
