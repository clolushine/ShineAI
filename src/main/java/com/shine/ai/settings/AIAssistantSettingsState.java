...
public class AIAssistantSettingsState implements PersistentStateComponent<AIAssistantSettingsState> {
  ...
  public Map<Integer,String> AIClassNameList = new HashMap<>(){{
    ...
    put(8, Nvidia_SETTING_CLASS_NAME);
  }};
  ...
  // Nvidia AI
  public String NvidiaAISettingInfo = initAISettingInfo();
  ...
  public JsonObject getAISettingInfo(String panelName) {
    ...
    switch (panelName) {
      ...
      case Nvidia_AI_CONTENT_NAME -> getTarget = NvidiaAISettingInfo;
  ...
  public void setAISettingInfo(String panelName,JsonObject settingInfo) {
    switch (panelName) {
      ...
      case Nvidia_AI_CONTENT_NAME -> NvidiaAISettingInfo = setJsonObjectAction(NvidiaAISettingInfo,settingInfo);
  ...
  public boolean currentModelCanOnline(String panelName,String model) {
    ...
    switch (panelName) {
      ...
      case GROQ_AI_CONTENT_NAME, OpenAI_CONTENT_NAME, OpenRouter_AI_CONTENT_NAME, DeepSeek_AI_CONTENT_NAME, Nvidia_AI_CONTENT_NAME, Anthropic_AI_CONTENT_NAME -> {}
      default -> {}
    }
    return isCan;
  }
  ...
  public boolean currentModelCanImage(String panelName,String model,JsonArray modelList) {
    ...
    switch (panelName) {
      ...
      case OpenAI_CONTENT_NAME, DeepSeek_AI_CONTENT_NAME, Nvidia_AI_CONTENT_NAME, Anthropic_AI_CONTENT_NAME -> {}
      default -> {}
    }
    return isCan;
  }
